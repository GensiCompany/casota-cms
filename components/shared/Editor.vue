...
.ql-container.ql-snow, .ql-toolbar.ql-snow {
    border: 1px solid #cccecc !important;
}
.ql-toolbar.ql-snow .ql-picker.ql-expanded .ql-picker-label, .ql-toolbar.ql-snow .ql-picker-options {
    border:0 !important;
}
